#ifndef __PID_Cdelta_U_sfun_h__
#define __PID_Cdelta_U_sfun_h__
...
extern mxArray* load_PID_Cdelta_U_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_PID_Cdelta_U_optimization_info(void);
