  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3939263305U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2970968172U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(266697628U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2177246435U);
    } else {
      return 0;
    }
  } else {
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4151034156U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4124073184U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(471550974U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(500415433U);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(instanceChksum, "sMCbMp6zyGzNnUZMRpYspNG") == 0) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(tpChksum, "sMCbMp6zyGzNnUZMRpYspNG") == 0) {
     ...
     case 2:
      {
        if (strcmp(tpChksum, "sMCbMp6zyGzNnUZMRpYspNG") == 0) {
          ...
          const char* encoded_post_codegen_info =
            sf_c2_untitled_get_post_codegen_info();
